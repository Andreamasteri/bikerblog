  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12">
        <div>
          <h1 className="text-4xl md:text-6xl font-display font-bold uppercase tracking-tight mb-4 leading-none">The Archives</h1>
          <p className="text-muted-foreground max-w-xl">Every ride, every wrench turned, every story from the road. Search the archives or browse by latest.</p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-24 bg-muted/20 border border-dashed">
          <h3 className="text-2xl font-display font-bold uppercase mb-2">Dead End</h3>
          <p className="text-muted-foreground">No posts found matching your search. Try a different route.</p>
        </div>
      ) : (
