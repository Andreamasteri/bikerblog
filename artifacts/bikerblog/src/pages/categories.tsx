  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="mb-12 border-b border-border pb-8">
        <p className="text-sm font-bold uppercase tracking-widest text-primary mb-2">{t("categories.label")}</p>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-24 bg-muted/20 border border-dashed">
          <p className="text-muted-foreground">{t("categories.noResults")}</p>
        </div>
      ) : (
